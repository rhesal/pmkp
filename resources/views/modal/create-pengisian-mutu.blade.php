                ...
                <div class="form-row">
                    <div class="form-group col-6 ">
                        ...
                        <div class="form-row mx-0" style="max-width: 100%">
                            ...
                            <div class="form-group col-9 mb-0">
                                <input type="text" class="form-control datepicker align-top">
                            </div>
                        </div>
                        <div class="form-row mx-0" style="max-width: 100%">
                            <div class="form-group col-md-2 mb-0">
                            ...
                            <div class="form-group col-9 mb-0">
                                ...
                                <input name="numerator" type="text" class="form-control" placeholder="Nilai Numerator">
                            </div>
                        </div>
                        <div class="form-row mx-0" style="max-width: 100%">
                            <div class="form-group col-md-2 mb-0">
                            ...
                            <div class="form-group col-9 mb-0">
                                ...
                                <input name="denumerator" type="text" class="form-control" placeholder="Nilai denumerator">
                            </div>
                        </div>
                        <div class="form-row mx-0" style="max-width: 100%">
